...
class ResetPassDialog(private val message: String, private val positiveCallBack: (() -> Unit)?) : BaseFullscreenDialog() {
    ...
    override fun tag(): String = ResetPassDialog::class.java.name
}